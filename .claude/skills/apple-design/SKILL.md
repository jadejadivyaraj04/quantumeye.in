---
name: apple-design
description: Apple-inspired UI design system (glassmorphism, minimalist, dark mode). Manual-only — invoke explicitly with /apple-design or by saying "use apple-design skill". Do NOT auto-trigger on generic design/portfolio/landing-page requests.
---
