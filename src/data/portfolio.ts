...
export const identity: Identity = {
  ...
  positioning:
    "I build cross-platform mobile apps for teams that ship at scale - Nike, BBC Earth and Heracles Almelo among them - and lately, apps that run a language model on the phone rather than behind an API.",
  ...
  resumeUrl: null,
  currently: {
    note: "Putting small models on the phone instead of behind an API: prescriptions read into a dose schedule offline, receipts and statements parsed on device, and a storefront that answers inside ChatGPT over MCP.",
